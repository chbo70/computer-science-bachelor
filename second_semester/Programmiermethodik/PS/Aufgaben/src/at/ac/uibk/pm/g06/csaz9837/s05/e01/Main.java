...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        MyCustomClass1 mcc1b = new MyCustomClass1(17, "text", 13.4, 20);
        ...
        MyCustomClass2 mcc2c = new MyCustomClass2(17, "hallo", 13.4, Integer.valueOf(20));
        MyCustomClass2 mcc2d = new MyCustomClass2(18, "hallo", 12.3, Integer.valueOf(800));

        System.out.println(mcc2a.toString() + mcc2b.toString() + mcc2a.equals(mcc2b));
        System.out.println(mcc2a.toString() + mcc2c.toString() + mcc2a.equals(mcc2c));
        System.out.println(mcc2a.toString() + mcc2d.toString() + mcc2a.equals(mcc2d));
