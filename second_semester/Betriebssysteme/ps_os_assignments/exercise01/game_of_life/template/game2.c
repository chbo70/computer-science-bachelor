...
int *randomGamefield(int rows, int columns, double density) {//--------------------------------------------------------------------------------------------------
	int* field = NULL; //(int*)malloc(rows * columns * sizeof(int));
	int i, j;
...
int main(int argc, char* argv[]) {
    ...
    source = randomGamefield(height, width, density);//--------------------------------------------------------------------------------------------------
...
/*
	for (int i = 0; i < height; ++i)
	{
		...
		{
			live_cell = countNeighbours(height, width, i, j, source);
			printf("%d",live_cell);//--------------------------------------------------------------------------------------------------
		}
	}
*/
	// int destination = gamefield(height, width, density);
	// printf("%f", getRandomNumber());
